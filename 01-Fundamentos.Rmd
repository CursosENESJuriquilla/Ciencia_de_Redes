...
Existen varias funciones relacionadas al tema de **assortativity** en NetworkX.
...
- Pares de atributos y pares de grados: Estas funciones muestran los pares observados a lo largo de las aristas.

```{python}
print("Pares (group, group) en las aristas:")
print(list(nx.node_attribute_xy(G, "group")))
```

```{python}
print("Pares (grado, grado) en las aristas:")
